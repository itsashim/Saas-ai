                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    <button type="button" class="btn btn-sm btn-outline--primary editCategory" data-id="{{ $category->id }}" data-name="{{ __($category->name) }}" data-icon="{{ $category->icon }}" data-status="{{ $category->status }}" data-toggle="tooltip"  data-original-title="@lang('Edit')">
