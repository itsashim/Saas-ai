...
@section('panel')
                            ...
                            {{--    <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="coupon_code"
                                        value="{{ $coupon ? $coupon->coupon_code : old('coupon_code') }}" required>
                                </div>
                            </div>  --}}
                            <div class="col-md-6">
                                <div class="form-group">
    ...
    @endforeach-->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="price"
                                        value="{{ $coupon ? $coupon->price : old('price') }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            {{--      <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="number" step="any" name="cashback" value="{{ $coupon ? $coupon->cashback : old('cashback') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('Website Url')</label>
                                    <input class="form-control" type="text" name="url"
                                        value="{{ $coupon ? $coupon->url : old('url') }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
