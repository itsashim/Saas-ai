        ...
        <div class="container">
            <div class="row justify-content-center g-4 mb-5">
                <div class="col-sm-6 col-xl-4">
                    <a href="{{ route('user.coupon.pending') }}" class="dashboard__item">
                        <span class="dashboard__icon">
                            <i class="las la-pause-circle"></i>
                        </span>
                        <div class="cont">
                            <h3 class="title">{{ $widget['pending_coupon'] }}</h3>
                            <p class="text-dark">@lang('Pending Coupon')</p>
                        </div>
                    </a>
                </div>
                <div class="col-sm-6 col-xl-4">
                    <a href="{{ route('user.coupon.active') }}" class="dashboard__item">
                        <span class="dashboard__icon">
                            <i class="las la-check-circle"></i>
                        </span>
                        <div class="cont">
                            <h3 class="title">{{ $widget['active_coupon'] }}</h3>
                            <p class="text-dark">@lang('Active Coupon')</p>
                        </div>
                    </a>
                </div>
                <div class="col-sm-6 col-xl-4">
                    <a href="{{ route('user.coupon.rejected') }}" class="dashboard__item">
                        <span class="dashboard__icon">
                            <i class="las la-ban"></i>
                        </span>
                        <div class="cont">
                            <h3 class="title">{{ $widget['rejected_coupon'] }}</h3>
                            <p class="text-dark">@lang('Rejected Coupon')</p>
                        </div>
                    </a>
                </div>
                <div class="col-sm-6 col-xl-4">
                    <a href="{{ route('user.coupon.all') }}" class="dashboard__item">
                        <span class="dashboard__icon">
                            <i class="las la-list"></i>
                        </span>
                        <div class="cont">
                            <h3 class="title">{{ $widget['total_coupon'] }}</h3>
                            <p class="text-dark">@lang('Total Coupon')</p>
                        </div>
                    </a>
                </div>
                <div class="col-sm-6 col-xl-4">
                    <a href="{{ route('user.store.index') }}" class="dashboard__item">
                        <span class="dashboard__icon">
                            <i class="las la-store"></i>
                        </span>
                        <div class="cont">
                            <h3 class="title">{{ $widget['total_store'] }}</h3>
                            <p class="text-dark">@lang('Total Store')</p>
                        </div>
                    </a>
                </div>
                <div class="col-sm-6 col-xl-4">
                    <a href="{{ route('ticket') }}" class="dashboard__item">
                        <span class="dashboard__icon">
                            <i class="la la-ticket"></i>
                        </span>
                        <div class="cont">
                            <h3 class="title">{{ $widget['total_ticket'] }}</h3>
                            <p class="text-dark">@lang('Pending Support Ticket')</p>
                        </div>
                    </a>
                </div>
            </div>
            <div class="card custom--card border-0 dashboard-table-card">
                <div class="card-header section--bg d-flex flex-wrap justify-content-between algin-items-center">
                    <h4 class="title text--dark">@lang('My Coupon list')</h4>
                    <a href="{{ route('user.coupon.all') }}" class="btn btn--base btn-sm">@lang('View All')</a>
                </div>
                            ...
                            <tbody>
                                @forelse ($coupons as $coupon)
                                    <tr>
                                        ...
                                        <td data-label="Featured">{{ $coupon->featured_validity >= now() ? showDateTime($coupon->featured_validity, 'Y-m-d') : '-' }}</td>
