            ...
            <div class="col-lg-3">
                <div class="sidebar">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <button class="active" id="all-tab" data-bs-toggle="pill" data-bs-target="#all" type="button"
                        ...
                        <!-- All categories End -->
                        <!-- AI detector Start -->
                        <button class="nav-link" id="detector-tab" data-bs-toggle="pill" data-bs-target="#detector"
                            type="button" role="tab" aria-controls="detector" aria-selected="false">
                            <span class="sm_icon d-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
                                    <path
            ...
            <div class="col-lg-9">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
                        <div class="ai_cards d-flex flex-wrap gap-4 justify-content-center justify-content-sm-start">
                            ...
                            @forelse($coupons as $coupon)
                             ...
                             {{ $coupon->reports_count }} @lang('used today')
                                        ...
                                        <div class="tag_wrap mt-3  mb-3 d-flex gap-2">
                    ...
                    <!-- All categories End -->
                    <!-- AI detector Start -->
                    <div class="tab-pane fade text-white" id="detector" role="tabpanel" aria-labelledby="vdetector-tab">
                        <div class="ai_cards d-flex flex-wrap gap-4 justify-content-center justify-content-sm-start">
